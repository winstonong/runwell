...
const testimonials = [
  {
    quote: "We replaced two part-time local hires with one Runwell VA. The quality of work went up, the cost went down by 70%, and we haven't looked back. It took less than a week to get started.",
    name: "Krystal Nguyen",
    role: "COO, Vantage Growth Partners",
    result: "70% cost reduction, fully operational in 5 days",
  },
  {
    quote: "I was spending $4,200/month on a local admin assistant. My Runwell VA handles the same workload — plus social media and CRM — for under $1,000/month. The ROI is undeniable.",
    name: "Tom Gallagher",
...
const faqs = [
  { question: "How much does a virtual assistant cost?", answer: "Runwell VAs range from $4–$8 per hour depending on the role complexity and hours required. This is an all-in rate — no hidden fees, no benefits overhead, no recruiting costs. Most clients save 60–70% compared to hiring locally." },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-3" style={{ color: DARK }}>
              Why 1,200+ businesses choose Runwell
            </h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="flex-1 space-y-6">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Traditional hiring takes 4–8 weeks, costs thousands in recruiter fees, and still might not work out. With Runwell, you describe what you need, we match you with a pre-vetted professional, and you&apos;re delegating within days.
              </p>
