...
const testimonials = [
  {
    quote: "I run a dental practice with two locations. I was spending 15 hours a week on scheduling, insurance follow-ups, and patient communications. My Virtual Assistants Philippines VA took all of that off my plate for $480/month. I can actually focus on my patients now.",
    name: "Dr. Amanda Chen",
...
const faqs = [
  { question: "I'm a small business — can I really afford a VA?", answer: "A Virtual Assistants Philippines VA costs $4–$8/hr. That's $320–$640/month for 20 hours/week. Compare that to a local part-time hire at $18–25/hr ($1,440–$2,000/month) plus benefits and management overhead. Most small business owners save 60–75% with Virtual Assistants Philippines." },
  ...
  { question: "What about data security?", answer: "All Virtual Assistants Philippines VAs sign NDAs and data handling agreements. We follow industry-standard security practices and can work within your existing security tools and protocols." },
  ...
  return (
    <>
      ...
      <section style={{ backgroundColor: "#FAFAF7" }}>
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            <SectionHeading title="What Your VA Actually Does All Day" subtitle="Real tasks. Real results. Here's how Virtual Assistants Philippines VAs support small businesses like yours." titleColor={GREEN} />
          </div>
          {useCases.map((u, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="rounded-2xl border-2 p-8" style={{ borderColor: GREEN, backgroundColor: "#F0FDF4" }}>
              <h3 className="font-heading font-bold text-xl mb-4" style={{ color: GREEN }}>With a Virtual Assistants Philippines VA</h3>
              <ul className="space-y-3 text-sm" style={{ color: "#166534" }}>
                ...
                <li className="flex justify-between border-t pt-3" style={{ borderColor: `${GREEN}30` }}><span className="font-bold">Monthly cost with Virtual Assistants Philippines</span><span className="font-bold">$360–$640</span></li>
              </ul>
            </div>
          </div>
        </div>
